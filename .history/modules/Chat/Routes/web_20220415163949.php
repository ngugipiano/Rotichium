...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    //chat_view
	Route::get('/user-chats', 'UserChatController@admin_chat_index')->name('chat.admin.all');
	Route::get('/user-chats/{id}', 'UserChatController@admin_chat_details')->name('chat_details_for_admin');
