...
//chat_view
Route::get('/user-chats', 'TextController@admin_chat_index')->name('chat.admin.all');
Route::get('/user-chats/{id}', 'TextController@admin_chat_details')->name('chat_details_for_admin');
