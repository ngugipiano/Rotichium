        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input type="number" min="0" step="0.01" class="form-control" name="value" @if ($club_point_convert_rate != null) value="{{ $club_point_convert_rate->val }}" @endif placeholder="100" required>
                    </div>
                    <div class="col-lg-3">
