...
// User package
Route::get('user-packages', 'UserPackageController@index')->name('user_packages.index');
Route::get('user-packages/create', 'UserPackageController@create')->name('user_packages.create');
Route::post('user-packages/{id}', 'UserPackageController@store')->name('user_packages.store');
Route::get('/user-packages/edit/{id}', 'UserPackageController@edit')->name('user_packages.edit');
Route::post('/user-package/update/{id}', 'UserPackageController@update')->name('user_packages.update');
Route::get('/user-packages/destroy/{id}', 'UserPackageController@destroy')->name('user_packages.destroy');
Route::get('/user/package-payments', 'UserPackageController@package_purchase_history')->name('package_purchase_history');


//chat_view new routes
