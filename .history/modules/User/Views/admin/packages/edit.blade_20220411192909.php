        ...
        <div class="row">           
            <form class="p-4" action="{{ route('user_packages.update', $row->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" value="{{ $row->getTranslation('name', $lang) }}" placeholder="{{__('Name')}}" id="name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 col-from-label" for="item_upload_limit">{{__('Item Upload Limit')}}</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label class="col-sm-2 col-from-label" for="commission">{{__('Commission')}}</label>
                    <div class="col-sm-10">
