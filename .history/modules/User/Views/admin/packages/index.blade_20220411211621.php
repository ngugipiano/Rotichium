                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-body text-center">
                                <p class="mb-3 h6 fw-600 fs-18">{{ $user_package->getTranslation('name') }}</p>
                                ...
                                <div class="mar-top">
                                    ...
                                    <a href="{{route('user_packages.destroy', $user_package->id)}}"  class="btn btn-sm btn-danger">{{__('Delete')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
