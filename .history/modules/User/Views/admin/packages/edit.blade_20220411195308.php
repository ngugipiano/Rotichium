            ...
            <form class="p-4" action="{{ route('user_packages.update', $row->id) }}" method="POST">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="col-md-2 col-form-label" for="name">{{__('Package Name')}}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="col-md-2 col-form-label" for="item_upload_limit">{{__('Item Upload Limit')}}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="col-md-2 col-form-label" for="commission">{{__('Commission')}}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label class="col-md-2 col-form-label" for="duration">{{__('Duration')}}</label>
                        <div class="col-sm-10">
                            <div class="input-group">
