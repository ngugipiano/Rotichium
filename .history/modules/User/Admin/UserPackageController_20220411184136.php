...
use Modules\UserPackage\Entities\Package;
use Modules\UserPackage\Entities\PackagePayment;
use App\Models\UserProfile;
use Modules\UserPackage\Entities\UserPackage;
use Modules\Staff\Entities\Role;
use Auth;
use Session;
...
class UserPackageController extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('userpackage::admin.index', compact('packages'));

    }

    public function create()
    {
        return view('userpackage::admin.create');
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('userpackage::admin.edit', compact('package', 'lang'));
    }
