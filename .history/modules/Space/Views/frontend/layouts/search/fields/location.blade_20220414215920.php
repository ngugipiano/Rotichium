...
<div class="form-group">
    ...
    <div class="form-content">
        ...
        <div class="smart-search">
            <input class="smart-search-location parent_text form-control" value="{{Request::query('location_name')}}" type="text" name="location_name" id="autocomplete" class="form-control" placeholder="{{__("Where are you going?")}}">
