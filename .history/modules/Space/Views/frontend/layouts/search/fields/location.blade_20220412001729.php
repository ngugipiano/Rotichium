    ...
    <div class="form-content">
        ...
        @if($location_search_style=='autocompletePlace')
            <div class="g-map-place" >
                <input type="text" name="map_place" placeholder="{{__("Where are you goingg?")}}"  value="{{request()->input('map_place')}}" class="form-control border-0">
        ...
        <div class="smart-search">
            <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("space_location_search_style")) or setting_item("space_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you goingg?")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
