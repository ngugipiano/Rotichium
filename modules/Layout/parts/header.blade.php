    ...
    <div class="{{$container_class ?? 'container'}}">
        <div class="content" style="background:white;">
                        ...
                        <li class="login-item dropdown">
                            ...
                            <ul class="dropdown-menu text-left">
                                ...
                                @if(Auth::user()->hasPermissionTo('dashboard_vendor_access'))
                                    <li><a href="{{route('vendor.dashboard')}}"><i class="icon ion-md-analytics"></i> {{__("Host Dashboard")}}</a></li>
                                @endif
            ...
            <div class="menu-right">
                @if(!Auth::check())
                    <button class="btn btn-primary" data-toggle="modal" data-target="#register" class="signup">
                        {{ __("Start my free trial") }}
                    </button>
                    <div class="space">
                    </div>
                    <button class="btnn success" data-toggle="modal" data-target="#login" class="login">
                        {{ __("Login") }}
                    </button>
                @else
                <a href="{{route('admin.index')}}" class="btn btn-primary">My Dashboard</a>
                @endif
            </div>
        </div>
    </div>
