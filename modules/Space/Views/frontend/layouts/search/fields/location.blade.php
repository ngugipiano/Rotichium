...
<div class="form-group">
    ...
    <div class="form-content">
        ...
        <div class="smart-search">
            <input class="smart-search-location parent_text form-control" value="{{Request::query('location_id')}}" type="text" name="location_id" id="autocomplete" class="form-control" placeholder="{{__("Where are you going?")}}">
